...
class vJoy(object):
    ...
    def generateJoystickPosition(self, 
        ...
        #       joy:    0<-16393->32786   , trig:   0->32786    
        wAxisXRot = 16393, wAxisYRot = 16393, wAxisZRot = 0,
        # 32786 is max, 0 is min and 16393 is the center of joystick
...
def test():
    ...
    for i in range(0,1000,1):
        ...
        xPos = int(10000.0*np.sin(2.0*np.pi*i/100))#2.0*np.pi*i/1000
...
def look_right():
    ...
    vj.update(joystickPosition)
    time.sleep(3)
    joystickPosition = vj.generateJoystickPosition(wAxisXRot = 16393)
    vj.update(joystickPosition)
    vj.close()
...
def steer_right():
    time.sleep(3)
    vj.open()
    joystickPosition = vj.generateJoystickPosition(wAxisX = 32786, wAxisY = 32786)
    vj.update(joystickPosition)
    time.sleep(5)
